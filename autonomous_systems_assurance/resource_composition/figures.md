...
| F-010 | [Public-assurance coverage map](figures/assurance_coverage_map.png) ([editable SVG](figures/assurance_coverage_map.svg)) | rendered, baseline extension pending | [C-RISK-006] [C-RISK-007] [C-CHAL-001] [C-CHAL-006] [C-AUTH-010] [C-DIR-003] [C-BASE-001] [C-BASE-003] [C-BASE-004] | A source-scoped map, not a ranking. The manuscript now adds conventional and road-stack comparisons; the visual extension is queued because it needs a dedicated readability render. |
